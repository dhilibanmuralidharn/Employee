...
public class EmployeeService implements EmployeeRepository {
    ...
    public ArrayList<Employee> getEmployees() {
        ...
        ArrayList<Employee> employeesList = new ArrayList<>(employeesCollection);
    ...
    public Employee updateEmployee(int employeeId, Employee employee) {
        Employee exisitingEmployee = employeeList.get(employeeId);
        if (exisitingEmployee == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
        if (employee.getEmployeeName() != null) {
            exisitingEmployee.setEmployeeName(employee.getEmployeeName());
        }
    ...
    public void deleteEmployee(int employeeId) {
        Employee exiEmployee = employeeList.get(employeeId);
        if (exiEmployee == null) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        } else {
